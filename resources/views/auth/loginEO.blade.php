...
<body>
    ...
    <div id="auth">
        <div class="login-container">
            ...
            <h1 class="auth-title">Log in EO</h1>
            ...
            <form method="POST" action="{{ route('loginEO') }}">
                ...
                <button class="btn btn-primary btn-block btn-lg shadow-lg" style="width: 100%;">Log in</button>
            </form>
            <div class="footer-links">
                <p class="text-gray-600">Don't have an account? <a href="{{ route('registerEO') }}" class="font-bold">Sign up</a>.</p>
                <p><a class="btn btn-secondary" href="{{ route('login') }}">Login as User</a></p>
            </div>
        </div>
    </div>
